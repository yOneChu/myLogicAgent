...
| 항목 | 내용 |
|---|---|
| URL | `POST https://vault-in.hdel.co.kr:8070/dash/searchMissPartofProduct` |
...
화면(`https://vault-in.hdel.co.kr:8070/dash/searchPartAnalysis`) → `POST https://vault-in.hdel.co.kr:8070/dash/searchMissPartofProduct` 와 **동일한 결과**를 자연어 요청으로 얻기 위한 입력 양식이다.
